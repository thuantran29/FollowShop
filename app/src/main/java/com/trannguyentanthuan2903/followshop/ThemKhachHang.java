...
public class ThemKhachHang extends AppCompatActivity {
    ...
    EditText edtHoTenKH, edtSDTKH, edtDiaChiKH, edtIdKH;
    Button btnThemKH;
    ImageView imgHinhKh, imgBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnThemKH.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BitmapDrawable drawable = (BitmapDrawable) imgHinhKh.getDrawable();
...
//                        Toast.makeText(ThemKhachHang.this, "Lưu hình Khách Hàng thành công", Toast.LENGTH_SHORT).show();
                        ...
                        KhachHang loaiSanPham = new KhachHang(
                                null,
                                edtHoTenKH.getText().toString().trim(),
                                edtSDTKH.getText().toString().trim(),
                                edtDiaChiKH.getText().toString().trim(),
                                String.valueOf(downloadUrl)
                        );
                        mDatabase.child(key).child("KhachHang").push().setValue(loaiSanPham, new DatabaseReference.CompletionListener() {
                            @Override
                            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                if (databaseError == null) {
                                    Toast.makeText(ThemKhachHang.this, "Thêm khách hàng thành công.", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(ThemKhachHang.this, "Lỗi thêm thêm khách hàng!", Toast.LENGTH_SHORT).show();
                                }
        ...
        imgHinhKh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               xetDialog();
            }
    ...
    private void xoaAvatar() {
        imgHinhKh.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ThemKhachHang.this);
                builder.setTitle("Thông báo!");
                builder.setMessage("Bạn có muốn xóa Avatar");
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        imgHinhKh.setImageResource(R.drawable.product_icon);
                    }
                });
    ...
    private void xetDialog() {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(ThemKhachHang.this);
        ...
        builder1.setPositiveButton("Camera", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                ActivityCompat.requestPermissions(ThemKhachHang.this,
        ...
        switch (requestCode) {
            case REQUEST_CODE_CAMERA: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(ThemKhachHang.this, "Bạn không có quyền truy cập máy ảnh", Toast.LENGTH_SHORT).show();
                }
                return;
            }
            case REQUEST_CODE_FOLDER: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(ThemKhachHang.this, "Bạn không có quyền truy cập thư viện ảnh", Toast.LENGTH_SHORT).show();
                }
                return;
            }
        }
...
//                options.inPreferredConfig = Bitmap.Config.RGB_565;
                ...
                imgHinhKh.setImageBitmap(bitmap);
...
//            <uses-permission android:name="android.permission.READ_EXTERNAL_STORAGE"/>
        ...
        if (requestCode == REQUEST_CODE_CAMERA && resultCode == RESULT_OK && data != null) {
            ...
            imgHinhKh.setImageBitmap(photo);
        }
        super.onActivityResult(requestCode, resultCode, data);
    }
    private void AnhXa() {

        edtHoTenKH = (EditText) findViewById(R.id.suaHoTenKH);
        edtDiaChiKH = (EditText) findViewById(R.id.suaDiaChiKH);
        edtSDTKH = (EditText) findViewById(R.id.suaSDTKH);
        btnThemKH = (Button) findViewById(R.id.buttonThemKH);
        imgHinhKh = (ImageView) findViewById(R.id.imageViewHinhKH);
